 ...
 */
public class EnemyBulletCollisionSystem extends EntitySystem implements Listener<CollisionEvent>
{
    ...
    public EnemyBulletCollisionSystem(Signal<Entity> EntityRemovalSignal, Signal<String> SoundSignal,
